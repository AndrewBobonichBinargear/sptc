...
function custom_theme_customizer( $wp_customize ) {
  ...
  $wp_customize->get_section( 'title_tagline' )->title = __( 'Site Identity', 'seattlepremiumtowncarservice' );
  ...
  $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'header_logo_control', array(
      'label' => __( 'Logo', 'seattlepremiumtowncarservice' ),
...
function social_theme_customizer( $wp_customize ) {
  $wp_customize->add_section( 'social_media_section', array(
    'title' => __( 'Social Media Links', 'seattlepremiumtowncarservice' ),
    'priority' => 30,
  ) );
  ...
  $wp_customize->add_control( 'whatsup_url_control', array(
      'label' => __( 'Whatsup URL', 'seattlepremiumtowncarservice' ),
  ...
  $wp_customize->add_control( 'telegram_url_control', array(
      'label' => __( 'Telegram URL', 'seattlepremiumtowncarservice' ),
      'section' => 'social_media_section',
  ...
  $wp_customize->add_control( 'linkedin_url_control', array(
      'label' => __( 'LinkedIn URL', 'seattlepremiumtowncarservice' ),
      'section' => 'social_media_section',
...
function copyrights_theme_customizer( $wp_customize ) {
  $wp_customize->add_section( 'copyrights_section', array(
    'title' => __( 'Copyrights', 'seattlepremiumtowncarservice' ),
    'priority' => 100,
  ) );
  ...
  $wp_customize->add_control( 'copyrights_text_control', array(
      'label' => __( 'Copyrights Text', 'seattlepremiumtowncarservice' ),
