...
<body <?php body_class(); ?>>
	...
	<div class="header header_white" id="header_main">
		<header class="container">
				<div class="header__wrap">
					<?php if (theme_logo()) : ?>
						<?= theme_logo();  ?>
						<a href="/" class="header_white_logo" rel="home" aria-current="page" tabindex="0">
							<img src="/wp-content/uploads/2025/02/Demo-Logo.svg" width="300" class="site-logo" alt="logo" decoding="async">
						</a>
					<?php else : ?>
